                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="my-3">Dhanpal Singh</h5>
                                    <p class="text-muted mb-1">Full Stack Developer</p>
                                    <p class="text-muted mb-4">Surat, Gujarat, India</p>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">Dhanpal Rajpurohit</p>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">dhanpal@gmail.com</p>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="row">
